...
Scenario: A reviewer needs to decide whether an agent task using Security Scan Evidence can continue.

Completed example: Fill docs/security-scan-evidence.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
