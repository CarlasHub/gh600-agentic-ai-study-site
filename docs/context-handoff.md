...
Scenario: A reviewer needs to decide whether an agent task using Context Handoff can continue.

Completed example: Fill docs/context-handoff.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
