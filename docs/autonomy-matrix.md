...
Scenario: A reviewer needs to decide whether an agent task using Autonomy Matrix can continue.

Completed example: Fill docs/autonomy-matrix.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
