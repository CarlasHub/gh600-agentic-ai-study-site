...
Scenario: A reviewer needs to decide whether an agent task using Agent Handoff can continue.

Completed example: Fill docs/agent-handoff.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
