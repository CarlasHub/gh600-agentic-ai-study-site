...
Scenario: A reviewer needs to decide whether an agent task using Audit Trail can continue.

Completed example: Fill docs/audit-trail.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
