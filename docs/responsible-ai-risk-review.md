...
Scenario: A reviewer needs to decide whether an agent task using Responsible AI Risk Review can continue.

Completed example: Fill docs/responsible-ai-risk-review.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
