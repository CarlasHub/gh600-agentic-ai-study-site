...
Scenario: A reviewer needs to decide whether an agent task using Agent Memory Policy can continue.

Completed example: Fill docs/agent-memory-policy.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
