...
Scenario: A reviewer needs to decide whether an agent task using Recovery Plan can continue.

Completed example: Fill docs/recovery-plan.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
