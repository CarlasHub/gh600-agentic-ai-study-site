...
Scenario: A reviewer needs to decide whether an agent task using MCP Tool Policy can continue.

Completed example: Fill docs/mcp-tool-policy.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
