...
Scenario: A reviewer needs to decide whether an agent task using Environment Constraints can continue.

Completed example: Fill docs/environment-constraints.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
