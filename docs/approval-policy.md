...
Scenario: A reviewer needs to decide whether an agent task using Approval Policy can continue.

Completed example: Fill docs/approval-policy.md with task scope, evidence, owner, approval decision, and rollback path before the agent proceeds.
