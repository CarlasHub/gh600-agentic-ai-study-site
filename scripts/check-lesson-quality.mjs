...
const domainArtifactPatterns = {
  "domain-1": /^(?:\.github\/ISSUE_TEMPLATE\/agent-task\.yml|docs\/agent-task-contract\.md|docs\/agent-step-map\.md|docs\/agent-anti-pattern-review\.md|docs\/agent-plan\.md|docs\/agent-plan-approval-record\.md|docs\/agentic-vs-automation-decision-table\.md|docs\/pr-evidence-table\.md|docs\/workflow-evidence-record\.md|\.github\/pull_request_template\.md|\.github\/CODEOWNERS|docs\/agent-approval-gates\.md|docs\/agent-handoff\.md)$/,
  "domain-2": /^(?:docs\/agent-tool-permission-matrix\.md|docs\/mcp-tool-policy\.md|docs\/agent-mcp-server-review\.md|docs\/mcp-allowlist-decision\.md|docs\/execution-context-checklist\.md|docs\/tool-risk-classification\.md|docs\/agent-session-log-review\.md|docs\/pr-evidence-table\.md|docs\/audit-trail\.md|docs\/environment-constraints\.md|docs\/branch-scope-control\.md|docs\/escalation-paths\.md|\.github\/workflows\/copilot-setup-steps\.yml|\.github\/workflows\/agent-validation\.yml)$/,
  "domain-3": /^(?:docs\/agent-memory-policy\.md|docs\/agent-state\.md|docs\/resume-checkpoint\.md|docs\/stale-context-checklist\.md|docs\/memory-reset-decision\.md|docs\/decision-log\.md|docs\/context-handoff\.md)$/,
  "domain-4": /^(?:docs\/agent-evaluation-plan\.md|\.github\/workflows\/agent-validation\.yml|docs\/security-scan-evidence\.md|docs\/accessibility-scan-evidence\.md|docs\/root-cause-classification\.md|docs\/agent-failure-analysis\.md|docs\/error-analysis\.md|docs\/tuning-log\.md|docs\/regression-checklist\.md|docs\/agent-trace-review\.md)$/,
